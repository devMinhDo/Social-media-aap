...
const authCtrl = {
    register: async (req, res) => {
        try {
            ...
            if (newUser._doc.following.length === 0) {
                newUser._doc.following.push(new mongoose.Types.ObjectId("62a8a02f8be212a65212909c"))
            }
            
            await newUser.save().then(newUser => newUser.populate("followers following", "-password"))
